...
public interface CourseSessionRepository extends JpaRepository<CourseSession, Long> {
    ...
    List<CourseSession> findConflictingSessionsByRoom(@Param("room") String room,
    ...
    List<CourseSession> findByStartTimeLessThanAndEndTimeGreaterThan(LocalDateTime endTime, LocalDateTime startTime);
